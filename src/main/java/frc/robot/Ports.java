...
public class Ports {
    ...
    public static int ENCODER_DRIVETRAIN_LEFT_A_CHANNEL = 6;
    public static int ENCODER_DRIVETRAIN_LEFT_B_CHANNEL = 7;
    public static int ENCODER_DRIVETRAIN_RIGHT_A_CHANNEL = 8;
    public static int ENCODER_DRIVETRAIN_RIGHT_B_CHANNEL = 9;
    ...
    // PCM ports
    public static int CLIMBER_RELEASE_SOLENOID_CHANNEL_A = 0;
    public static int CLIMBER_RELEASE_SOLENOID_CHANNEL_B = 1;
    public static int INTAKE_SOLENOID_CHANNEL_A = 2;
    public static int INTAKE_SOLENOID_CHANNEL_B = 3;
    public static int CLIMBER_DEPLOY_SOLENOID_CHANNEL_A = 4;
